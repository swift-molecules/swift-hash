...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-hash-primitives open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-hash-primitives project authors
